...
namespace LinqToFile
{
    public class ExportStream
    {
        ...
        ExportFileDescription m_fileDescription;
        ...
        public void WriteRow(List<string> row)
        {
            ...
            {
                if (!firstItem && m_fileDescription.SeparatorChar.HasValue) { m_outStream.Write(m_fileDescription.SeparatorChar.Value); }
        ...
        private bool GetNextItem(ref string itemString)
        {
            ...
            while (true)
            {
                ...
                if ((postdata || !quoted) && c == m_fileDescription.SeparatorChar)
                {
                    // end of item, return
                    if (itemFound) { itemString = item.ToString(); }
                    return true;
